...
(function () {
     ...
     * الكامل، فنبحث عن نمط إيميل داخل كامل نص الزر بدل الاعتماد على عنصر
     * محدد بالضبط
     */
    function readCurrentUserEmail() {
        const trigger = document.querySelector('[data-testid="user-menu-button"]');
        return trigger ? findEmailInText(trigger.textContent) : "";
    }
    ...
    function resolveUserEmail(callback) {
        ...
        (function poll() {
            ...
            const email = menu ? findEmailInText(menu.textContent) : "";
