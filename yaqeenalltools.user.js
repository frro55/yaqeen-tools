...
(function () {
    ...
    /** يقرأ إيميل المستخدم الحالي من قائمة المستخدم بأعلى يقين */
    function readCurrentUserEmail() {
        const el = document.querySelector('[data-testid="user-menu-button"] span:last-child');
    ...
    function loadUserPermissions() {
        ...
        if (!email) {
            // قائمة المستخدم لسا ما ترسمت بالصفحة - نعيد المحاولة بدل ما نفشل نهائياً
